...
准确性，后面很多搜索系统也都受其影响。nsearch全文搜索引擎是我新造的轮子，它是配合nmid[(介绍链接)](https://www.niansong.top/2020/06/16/nmid%E5%88%86%E5%B8%83%E5%BC%8F%E5%BE%AE%E6%9C%8D%E5%8A%A1%E8%B0%83%E5%BA%A6%E7%B3%BB%E7%BB%9F/){:target="_blank"}微服务系统生态的一员，作为nmid的worker端提供分布式
搜索服务。
...
这里就需要对你的关键词和文本数据进行相关性算法计算了，nsearch这里用到了bm25算法，再通过bm25的值进行排序，同时可以进行结果分页处理。
...
## 最后
后面还会不断完善nsearch的相关文本匹配算法，以及存储数据结构的优化。